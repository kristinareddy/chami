...
assert.match(worker,/chami-v24-phonics-tactile-scaffolds/);
...
for(const doc of docs){
  ...
  assert.match(read(doc),/v24/i,`${doc} has not been updated for v24`);
}

console.log(`v24 release validation passed: ${scripts.length} scripts, ${cached.length} cached assets, ${docs.length} docs`);
